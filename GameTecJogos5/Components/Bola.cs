...
namespace GameTecJogos5.Components
{
    public class Bola
    {
        ...
        //Metodo construtor
        public Bola(ContentManager content, Vector2 posicao, Vector2 direcao, float velocidade = 0)
        {
            Textura = content.Load<Texture2D>("fancy-ball");
            Posicao = posicao;
        ...
        public void Acelerar(GameTime gameTime)
        {
            //Tempo real em segundos (deltatime)
            float tempoExecucao = (float)gameTime.ElapsedGameTime.TotalSeconds;
            //Calcular a movimentacao constante
